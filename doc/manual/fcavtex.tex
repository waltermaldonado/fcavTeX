...
Eu adoro tecnologia. A cada dia que trabalho com ela fico mais fascinado com todas as possiblilidades
e todos os recursos que ela nos oferece. Se compararmos algumas tarefas que executamos hoje com a maneira
...
\section{shareLaTeX} % (fold)
\label{sec:sharelatex}
O shareLaTeX é um serviço gratuito (apresenta versões aprimoradas pagas) que pode ser utilizado para gerar a sua dissertação ou tese. A principal vantagem desse serviço é que ele dispensa o download e instalação das pesadas distribuições LaTeX na sua máquina local. Sendo assim, basta você acessar o website \href{https://pt.sharelatex.com/}{https://pt.sharelatex.com/}, criar uma conta e gerar os seus documentos \LaTeX\ na hora!

Foi disponibilizado um projeto modelo para que seja possível checar como ocorre o processo de edição e compilação dos arquivos. Ele pode ser acessado através do link \href{https://pt.sharelatex.com/project/558eb0eed8509a876d9e2e51}{https://pt.sharelatex.com/project/558eb0eed8509a876d9e2e51}, porém não pode ser editado. 

No momento da compilação, os utilitários do \LaTeX\ buscam pelos arquivos de classe e de estilos bibliográficos na mesma pasta do arquivo principal do seu projeto (\emph{.tex}). Portanto, basta adicionar os arquivos \emph{unespfcav.bst} e \emph{unespfcav.cls} na mesma pasta do seu projeto. Tal procedimento vale para uma pasta em seu computador local, caso tenha instalado uma distribuição \LaTeX\ ou para um novo projeto no shareLaTeX, onde os arquivos podem ser visualizados na lista à esquerda na tela. Tais arquivos podem ser obtidos no site de desenvolvimento da classe \href{https://github.com/waltermaldonado/fcavTeX}{https://github.com/waltermaldonado/fcavTeX} e submetidos ao seu projeto pela ferramenta apropriada.
...
\begin{description}
    ...
    \item[Citação de trabalho em evento, impresso, eletrônico e CD-ROM] Foi adicionado um recurso para a inclusão dos termos `Anais...' e `Anais eletrônicos...', além do ajuste da ordem dos elementos volume, ano, local de publicação e editor. Tais citações são originadas do tipo BibTeX \emph{inproceedings}, listado no Zotero como `Conferência'.
...
\label{sec:colabore_com_a_fcavtex}
...
% section colabore_com_a_fcavtex (end)
